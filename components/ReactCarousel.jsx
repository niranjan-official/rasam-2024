...
const ReactCarousel = ({ images }) => {
    ...
    return (
        <Carousel responsive={responsive} className='w-full flex h-full z-10' partialVisible={true} infinite={true} autoPlay={true} autoPlaySpeed={3000} removeArrowOnDeviceType={['mobile','tablet']}>
